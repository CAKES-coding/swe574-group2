...
function incrementValue() {
    var upvoteNumberText = document.getElementById('upvote').innerText;
    ...
    document.getElementById('upvote').innerText = upvoteNumber;
}

// Downvote
function decrementValue() {
    var downvoteNumberText = document.getElementById('downvote').innerText;
    ...
    document.getElementById('downvote').innerText = downvoteNumber;
}